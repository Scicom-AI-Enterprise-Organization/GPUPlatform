...
// Proxy playground with a mode toggle (chat / embeddings / audio), mirroring the
// serverless endpoint playground. The proxy is OpenAI-compatible, so each mode just
// points the shared playground component at the matching data-plane path.
